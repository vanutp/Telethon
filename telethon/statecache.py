...
class StateCache:
    ...
    """
    _store: dict
    catching_up: 'typing.Dict[typing.Union[int, None], bool]'
    postponed_updates: 'typing.List[types.TLObject]'
    ...
    def __init__(self, initial, loggers):
        ...
        self._store = {}
        self.postponed_updates = []
        self.reset_catching_up()
        if initial:
    ...
    def reset_catching_up(self):
        self.catching_up = dict()
        self.catching_up[None] = False  # Global flag
